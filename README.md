...
**04-module:** Includes multiple projects (express_api, typescript_api, spring_api, react_app), each with its own Dockerfile, and demonstrates how Docker is used with them.
